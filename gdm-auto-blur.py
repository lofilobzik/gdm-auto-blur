...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('-br', '--brightness', type=float, required=(
        '-u' not in sys.argv), help='change brightness; from 0.00 to 1.00 and above')
    parser.add_argument('-b', '--blur', type=float, required=('-u' not in sys.argv),
